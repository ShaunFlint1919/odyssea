        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-base sm:text-lg text-stone-600 leading-relaxed space-y-4 lg:space-y-6">
              <p>
                Chez Odyssea Lymphea, nous avons fait le choix du changement, nous vous amenons au <strong>Brésil</strong>, chez la célèbre <strong>Renata Franca</strong>, pour une formation authentique en <strong>méthode originale</strong>.
              </p>
              <p>
